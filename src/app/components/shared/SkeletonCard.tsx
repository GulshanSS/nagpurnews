export default function SkeletonCard() {
  return (
    <>
      <div className="min-w-80 mx-2 my-4 flex gap-2 h-32 rounded-md p-2 border border-gray-200 shadow-md select-none">
        ...
        <div className="flex items-center justify-center w-20 bg-gray-300 animate-pulse rounded"></div>
